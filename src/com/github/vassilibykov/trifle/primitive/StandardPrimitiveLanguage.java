...
public final class StandardPrimitiveLanguage {

    private StandardPrimitiveLanguage() {}

    public static PrimitiveCall add(AtomicExpression arg1, AtomicExpression arg2) {
        return PrimitiveCall.with(Add.class, arg1, arg2);
    }

    public static PrimitiveCall greaterThan(AtomicExpression arg1, AtomicExpression arg2) {
        return PrimitiveCall.with(GT.class, arg1, arg2);
    }

    public static PrimitiveCall lessThan(AtomicExpression arg1, AtomicExpression arg2) {
        return PrimitiveCall.with(LT.class, arg1, arg2);
    }
